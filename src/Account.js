...
const Account = (props) => {
    ...
    return (
        ...
        <div className="p-4 flex flex-col items-center">
            <h3 className="text-lg font-semibold mb-2">Connected Account:</h3>
            <p className="text-sm mb-2 overflow-hidden overflow-ellipsis whitespace-nowrap">
                {props.currentAccount}
            </p>
            <p className="text-sm mb-2">Your balance:{balance}</p>
            <button className="w-full bg-indigo-500 hover:bg-indigo-700 text-white font-semibold py-2 px-4 rounded"
